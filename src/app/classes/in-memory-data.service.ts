...
export class InMemoryDataService implements InMemoryDbService {
  ...
  createDb() {
    ...
    const mbposts = [
      ...
      {id: 5, messageboardId: 2, draft: true, author: 0, created: this.created, title: 'Im tired', category: 0, content: 'Massvely drunk. Hope I am not posting this for real.', state: 'inactive'}
    ];
